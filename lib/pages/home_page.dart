                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CarouselSection(title: AppCategories.it, items: _it, onReturnFromDetail: () => _load(_search.text)),
                      const SizedBox(height: 10),
                      CarouselSection(title: AppCategories.languages, items: _lang, onReturnFromDetail: () => _load(_search.text)),
                      const SizedBox(height: 10),
